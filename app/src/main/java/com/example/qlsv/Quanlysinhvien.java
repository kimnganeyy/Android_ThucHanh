...
public class Quanlysinhvien extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lsStudent.add(new Student("Ngân","1","20","ngan@gmail.com","123456","đà nẵng"));
        lsStudent.add(new Student("Trần","2","20","tran@gmail.com","654321","đà nẵng"));
        lsStudent.add(new Student("Rốt","3","20","rot@gmail.com","123789","đà nẵng"));
